...
const AdminPanel = () => {
  ...
  return (
    <div className="admin-panel bg-light min-vh-100 pb-5 ChartAdmin1">
      ...
      {/* Offcanvas More Menu */}
      <div
        className="offcanvas offcanvas-end custom-offcanvas rounded-4 overflow-hidden border-light responsive-offcanvas"
        tabIndex="-1"
        id="moreMenu"
      >
        <div className="offcanvas-header justify-content-between py-2 px-3">
          <button
            type="button"
        ...
        <div className="offcanvas-body pt-2 px-3">
          {menuGroups.map(({ title, links }) => (
            <div key={title} className="mb-3 glass-section p-3" style={{ backgroundColor: '#e8f0fe', borderRadius: '12px' }}>
